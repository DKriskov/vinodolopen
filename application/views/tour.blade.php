...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<body>
				...
				<!-- Logo & Navigation -->
					...
					<nav id="main-navigation" class="visible-desktop">
						<ul class="first-level">
							...
							<li><a href="{{ URL::to('results/head') }}">Head to Head</a></li>
							...
							<li><a href="{{ URL::to('results/show') }}">Svi rezultati</a></li>
		...
		<div class="container" role="main">
			...
			<section id="main-content" class="row tour-content">
